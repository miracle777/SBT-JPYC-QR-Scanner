            ...
            <div className="ml-3">
              ...
              <div className="text-xs text-blue-700 space-y-2">
                ...
                <div className="bg-white p-3 rounded border">
                  ...
                  <p>決済履歴、SBT情報、位置情報などはすべてブラウザ内で管理され、外部に送信されることはありません。</p>
                  <p className="mt-2"><strong>ウォレットへの記録：</strong>決済時は接続しているウォレット（MetaMaskなど）にも送付先アドレスと金額が記録されます。ただし、位置情報やメモなどの付加情報はウォレットには記録されません。</p>
                  <p className="mt-1">ブラウザのデータを削除すると、このアプリ内の履歴は削除されますが、ウォレットの取引履歴は残ります。</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-sm text-blue-700 space-y-1">
              <div>✅ <strong>Ethereum Mainnet</strong>: <code className="text-xs">0xE7C3...3c29</code></div>
              <div>✅ <strong>Polygon Mainnet・Amoy</strong>: <code className="text-xs">0xE7C3...3c29</code></div>
