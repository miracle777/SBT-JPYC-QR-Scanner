...
4. **メモ保存機能**: QR 支払い／手動送付どちらでもメモを記録。
5. **マルチネットワーク**: テストネット／本番ネットワーク両対応。
6. **SBT ギャラリー**: 店舗発行 SBT をコレクション表示。
7. **来店ステージ**: 来店回数から顧客ランク（Bronze / Silver / Gold）を可視化。
...
![SBTギャラリー実装例](https://assets.st-note.com/img/1732115783-RXEVMivYeF92H7dNcT1pDKLZ.png)
